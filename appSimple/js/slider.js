...
const sliderBanners = [
    {
        img: "src/src_files/sliders01-1.png",
        link: "#",
        texto: ""
    },
    {
        img: "src/src_files/sliders-4.png",
        link: "#",
        texto: "Ou simplesmente adicione uma foto e escreva sobre ela"
    },
    {
        img: "src/src_files/slider02-1.png",
        link: "#",
        texto: "E o melhor: Você faz tudo pelo painel de controle!"
    }
];
...
function renderSlider() {
    ...
    sliderBanners.forEach((b, i) => {
        slidesHtml += `
            <div class="slide" data-index="${i}" style="display:${i === 0 ? 'block' : 'none'};">
                <a href="${b.link}" style="background:url('${b.img}') center top; display:block; min-height:320px;">
                    <div class="container">
    ...
    slider.querySelector('.slider-wrapper').innerHTML = slidesHtml;
